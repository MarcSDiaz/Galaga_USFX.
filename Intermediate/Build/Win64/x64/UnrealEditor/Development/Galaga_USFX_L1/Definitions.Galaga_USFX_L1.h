...
#define UE_PROJECT_NAME Galaga_USFX_L1
#define UE_TARGET_NAME Galaga_USFX_L1Editor
#define UE_MODULE_NAME "Galaga_USFX_L1"
...
#define GALAGA_USFX_L1_API DLLEXPORT
